...
export default function About() {
  return (
    <section 
      id="about" 
      className="relative pt-10 pb-20 md:pt-16 md:pb-32 px-6 md:px-20 bg-[#050505] overflow-hidden"
    >      
      ...
      <div className="absolute inset-0 z-0 [perspective:1000px] pointer-events-none">
        ...
        <div 
          className="absolute top-[-10%] left-[-50%] w-[200%] h-[100%] origin-top rotate-x-[60deg] opacity-[0.1]"
          style={{ 
      ...
      <div className="max-w-7xl w-full mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center relative z-10">
        ...
        >
          ...
          <div className="inline-flex items-center gap-3 px-4 py-2 border border-[#bcff00]/20 rounded-full mb-6 md:mb-8 bg-[#bcff00]/5 backdrop-blur-md">
            ...
            <h2 className="text-[#bcff00] text-[9px] md:text-[10px] font-black uppercase tracking-[0.4em]">
              / Personal Journey
            </h2>
          </div>
          
          <h3 className="text-white text-4xl md:text-7xl font-black uppercase tracking-tighter italic leading-[0.9] md:leading-[0.85] mb-6 md:mb-8">
            Membangun Jembatan <br /> 
            <span className="text-transparent [-webkit-text-stroke:1px_rgba(188,255,0,0.4)] drop-shadow-[0_0_15px_rgba(188,255,0,0.1)] text-3xl md:text-6xl not-italic block mt-2">
               Antara Ide & Kode.
            </span>
          </h3>

          <div className="relative group mb-8 md:mb-12">
            <p className="text-white/50 text-sm md:text-xl leading-relaxed max-w-xl border-l-2 border-white/10 pl-5 md:pl-8 group-hover:border-[#bcff00]/50 transition-colors duration-500 text-justify md:text-left">
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-8 pt-6 md:pt-8 border-t border-white/5">
            ...
            >
              <p className="text-[9px] md:text-[10px] text-[#bcff00] font-bold uppercase mb-2 md:mb-3 tracking-[0.2em]">Visi</p>
            ...
            >
              <p className="text-[9px] md:text-[10px] text-[#bcff00] font-bold uppercase mb-2 md:mb-3 tracking-[0.2em]">Misi</p>
              <p className="font-bold text-xs md:text-base uppercase tracking-tight text-white leading-tight">
