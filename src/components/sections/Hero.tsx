...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative w-full bg-[#050505] overflow-hidden flex flex-col pt-32 md:pt-48 pb-0">
      ...
      {/* PERBAIKAN: Mengecilkan skala di mobile (w-[200px]) agar minimalis */}
      <div className="absolute left-[50vw] md:left-[75vw] top-[300px] md:top-[50vh] -translate-x-1/2 -translate-y-1/2 z-[5] pointer-events-none">
        {mounted && (
          <div className="relative w-[200px] h-[200px] md:w-[450px] md:h-[450px] flex items-center justify-center scale-90 md:scale-100">

            {/* --- NAMA BERPUTAR --- */}
            <motion.svg
              animate={{ rotate: 360 }}
              transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
              className="absolute w-[180px] h-[180px] md:w-[420px] md:h-[420px] z-10 opacity-60 md:opacity-80"
              viewBox="0 0 100 100"
            >
              <defs>
                <path
            ...
            <motion.div
              ...
              className="absolute w-[150px] h-[150px] md:w-[360px] md:h-[360px] border-[1.2px] md:border-[1.5px] border-dashed border-[#bcff00]/30 rounded-full"
            />

            {/* Cahaya Pendar (Glow Background) */}
            <div className="absolute w-[120px] h-[120px] md:w-[320px] md:h-[320px] bg-[#bcff00]/10 md:bg-[#bcff00]/20 rounded-full blur-[30px] md:blur-[100px]" />

            {/* Frame Foto Profil (Minimalis di Mobile) */}
            <div className="relative w-28 h-28 md:w-72 md:h-72 rounded-full border-[2px] md:border-[6px] border-[#bcff00] p-1 md:p-2 bg-[#050505] overflow-hidden shadow-[0_0_20px_rgba(188,255,0,0.3)] md:shadow-[0_0_40px_rgba(188,255,0,0.4)] z-0">
               {/* Gantilah src di bawah dengan path gambar Anda */}
               <img 
                 src="/foto-profil.jpg" 
                 alt="Profile" 
            ...
            {/* Label PHP & JS EXPERT (Lebih Kecil di Mobile) */}
            <motion.div
              animate={{ y: [0, -5, 0] }}
              transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
              className="absolute top-[15%] md:top-[15%] -right-1 md:-right-10 px-2 md:px-3 py-0.5 md:py-1 bg-black border border-[#bcff00] text-[#bcff00] text-[6px] md:text-[9px] font-black uppercase tracking-[0.1em] rounded-full z-20 shadow-[0_0_10px_rgba(188,255,0,0.5)]"
            >
              PHP & JS EXPERT
            </motion.div>
          </div>
      ...
      {/* --- LAYER 3: KONTEN TEKS --- */}
      {/* PERBAIKAN: px-4 (lebih tipis) dan ml-0 agar teks benar-benar geser ke kiri layar */}
      <div className="container mx-auto px-4 md:px-12 relative z-10 flex-grow pb-20 md:pb-32">
        <motion.div
        ...
        >
          ...
          {/* Judul Utama */}
          <h1 className="text-[14vw] md:text-[8.5vw] font-black uppercase leading-[0.85] md:leading-[0.8] tracking-tighter text-white">
            New Tech
          </h1>
          <h1 className="text-[14vw] md:text-[8.5vw] font-black uppercase leading-[0.85] md:leading-[0.8] tracking-tighter text-transparent [-webkit-text-stroke:1px_#bcff00] drop-shadow-[0_0_20px_rgba(188,255,0,0.3)] mb-10 md:mb-14">
            Solution
          </h1>

          {/* Slogan */}
          <div className="max-w-[280px] md:max-w-md border-l-2 border-[#bcff00] pl-4 md:pl-6 mt-4 mb-10 md:mb-14 text-left">
